...
+=========================================================================*/
  ...
  BEGIN
    l_data := REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(p_data, '&', '&amp;'), '<', '&lt;'), '>', '&gt;'),CHR(13),' '),chr(10),' ');
  ...
  BEGIN
    ...
    FOR i IN 1..LENGTH(p_data) LOOP
      ...
      IF (SUBSTR(p_data,i,1) IN ( 'á', 'é', 'í', 'ó', 'ú'
                                , 'Á', 'É', 'Í', 'Ó', 'Ú')) THEN
        
        l_data := l_data ||SUBSTR(p_data,i,1);
        
      ELSIF (SUBSTR(p_data,i,1) = ASCIISTR(SUBSTR(p_data,i,1))) THEN
